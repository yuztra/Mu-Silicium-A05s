...
gDeviceMemoryDescriptorEx[] = {
  ...
  {"RAM Partition",     0x60000000, 0x18100000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
  {"SEC Debug",         0x78100000, 0x00900000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN},

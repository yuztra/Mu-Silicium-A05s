...
class CommonPlatform ():
    PackagesSupported = ("a05sPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('a05s', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "a05s", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "a05sPkg/a05s.dsc", "Platform Hardcoded")
